...
public class BotOrchestratorImpl implements BotOrchestrator {
    ...
    private final BrowserAgent browserAgent;
    ...
    public BotOrchestratorImpl(
        ...
        this.browserAgent = browserAgent1;
    }
    ...
    public void runSession(Long sessionId) {
        ...
        ExtractionSession session = extractionSessionService.findById(sessionId).orElseThrow(() -> new SessionNotFoundException(sessionId));
        ...
        try {
            ...
            for (ExtractionTarget target : session.getTargets()) {
                ...
                List<CreateExtractedPostDto> extractedPosts =
                        socialNetworkBot.execute(
                                target,
                                (action, successful) ->
